...
--marshalls a permutation vector to an integer
imp :: (Ptr CLong -> CLong -> CLong)-> PermVec -> Int
...
knuthRichards :: StackSortablePermutation -> Perm321
knuthRichards p = undefined
